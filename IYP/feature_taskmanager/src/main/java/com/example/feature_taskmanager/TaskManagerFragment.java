package com.example.feature_taskmanager;
...
import com.example.feature_taskmanager.adapter.TaskAdapter;
import com.example.feature_taskmanager.database.AppDatabase;
import com.example.feature_taskmanager.database.Task;
import com.example.feature_taskmanager.utils.AlarmUtils;
...
public class TaskManagerFragment extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		taskAdapter = new TaskAdapter(this, new ArrayList<>(), task -> {
			Intent intent = new Intent(TaskManagerFragment.this, TaskDetailActivity.class);
		...
		// Add task
		fabAdd.setOnClickListener(view -> startActivity(new Intent(TaskManagerFragment.this, AddTaskActivity.class)));
